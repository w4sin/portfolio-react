...
import BillingProduct from "../../components/billing-app/billing-product";
import BillingSummary from "../../components/billing-app/billing-summary";
...
const Billing = () => {
  return (
    <div
      className="flex flex-col items-center screen overflow-y-auto overflow-x-hidden"
      style={{
